create or replace view wo_proizvod_po_klasi as select  p.PROIZVOD#,p.NAZIV_PROIZVODA,p.ROK_VAZENJA,p.DATUM_OTV,p.GRUPA_PROIZVODA#,p.RADNIK#,p.JEDINICA_MERE#, p.DODATNI_NAZIV ,p.KOD_KB, 
...
p.DATUM_DEKOR_MESECA, p.slika, p.ID_JEDINICE_MERE_ALT_REF,  c.organizaciona_jedinica#, c.id_klasa_cene, c.id_cenovnik, c.datum_do, c.datum_ov, c.klasaCene, c.cena cena, null dezenIstruktira, null proizvodjac, null tipAkcije, null kolicinaPoPakovanju,  
...
km.vrsta_klasifikacije# , km.klasifikacija#, a.atribut#,     
